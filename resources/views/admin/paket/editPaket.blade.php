                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-sample" action="/paket/edit/{{ $paket->id }}" method="post">
                                                            ...
                                                            <div class="form-group row">
                                                                <label
                                                                    class="col-sm-2 col-form-label">Batas waktu</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" value="{{$paket->batas_waktu }}" name="batas_waktu" placeholder="cth: 1 hari / 8 jam ">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
